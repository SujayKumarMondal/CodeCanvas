const API_KEY = "26ff0b5f2dmsha445d6a8e2f5addp118e4djsn576b9ad93093"; // Get yours for free at https://rapidapi.com/organization/judge0
...
$(document).ready(function () {
    ...
    console.log("Hey, CodeCanvas is open-sourced: https://github.com/judge0/ide. Have fun!");
...
CodeCanvas assumes that content of executable is Base64 encoded.\n\
\n\
...
var sqliteSource = "\
-- On CodeCanvas your SQL script is run on chinook database (https://www.sqlitetutorial.net/sqlite-sample-database).\n\
...
var c3Source = "\
// On the CodeCanvas, C3 is automatically\n\
...
var nimSource = "\
# On the CodeCanvas, Nim is automatically\n\
...
var bosqueSource = "\
// On the CodeCanvas, Bosque (https://github.com/microsoft/BosqueLanguage)\n\
